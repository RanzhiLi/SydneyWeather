...
public class CurrentWeatherService extends IntentService {
    ...
    protected void onHandleIntent(Intent intent) {
        ...
        String latitude = preferences.getString(Constants.APP_SETTINGS_LATITUDE, "33.51");
        String longitude = preferences.getString(Constants.APP_SETTINGS_LONGITUDE, "151.12");
        ...
        try {
            URL url = new URL(Uri.parse("http://api.openweathermap.org/data/2.5/weather?APPID=5ad5e7c716b9c1c77790deb8fc72c62e&q=Sydney").toString());//Utils.getWeatherForecastUrl(Constants.WEATHER_ENDPOINT, latitude, longitude, units, locale);
    ...
    public void parseWeather(String data) {
        try {
            ...
            if (mainObj.has("temp")) {
                mWeather.temperature.setTemp(Float.parseFloat(mainObj.getString("temp"))-273);
            }
