...
public class SearchActivity extends AppCompatActivity {
    ...
    private void loadLastFoundCity() {
        if (mCites.isEmpty()) {
            String lastCity = mCityPref.getString(APP_SETTINGS_CITY, "Sydney");
            String lastCountry = mCityPref.getString(APP_SETTINGS_COUNTRY_CODE, "AU");
            String lastLat = mCityPref.getString(APP_SETTINGS_LATITUDE, "33.51");
            String lastLon = mCityPref.getString(APP_SETTINGS_LONGITUDE, "151.12");
